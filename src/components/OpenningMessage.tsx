export default function OpenningMessage() {
	return (
		<section className="p-6 bg-white rounded-lg shadow max-w-2xl m-4">
			<header className="mb-6 text-center">
				<h1 className="text-xl font-bold text-primary-700">인사말</h1>
			</header>
			<article className="space-y-4 text-md leading-relaxed text-gray-800">
				<p>
					안녕하세요
					<br />
				...
				<p>
					공사기간 동안 응원해주시고 기다려주신 분들께 진심어린 감사의 마음을 전합니다.
					그 따뜻한 마음들이 큰 힘이 되어 지금 이 자리에 설 수 있었습니다.
				</p>
				<p>
				...
				<p className="mt-6 text-right text-base text-gray-500">
					대표이사 김 희 택 올림
				</p>
			</article>
